...
goimports: FORCE
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/s3_exporter\e[0m\n"
	@goimports -w -local https://github.com/sapcc/s3_exporter internal/ $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
